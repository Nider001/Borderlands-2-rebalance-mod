...
12. Health of all badass enemies (including bosses) is increased by 40%
13. Enemies now have a chance to carry a different weapon type instead of the base one (e.g. Marauders may to use Assault Rifles or Launchers instead of Shotguns)
14. Golden Chest is no longer guaranteed to contain purple gear
15. Torgue Vending Machines are no longer allowed to have legendary gear as an item of the day (replaced with purple gear instead)
16. All gear other than items of the day are removed from Torgue Vending Machines
17. Bonus enemy stats for extra coop players are significantly reduced
